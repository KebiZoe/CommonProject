...
-(instancetype)init{
    if (self = [super init]) {
        ...
        [cancel setTitleColor:[UIColor colorWithRed:0.012 green:0.663 blue:0.957 alpha:1.000] forState:UIControlStateNormal];
        cancel.titleLabel.font = [UIFont fontWithName:@"STHeitiSC-Light" size:18];
        ...
        [sure setTitleColor:[UIColor colorWithRed:0.012 green:0.663 blue:0.957 alpha:1.000] forState:UIControlStateNormal];
        sure.titleLabel.font = [UIFont fontWithName:@"STHeitiSC-Light" size:18];
